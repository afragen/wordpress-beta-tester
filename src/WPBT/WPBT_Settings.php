...
class WPBT_Settings {
	...
	private function saved_settings_notice() {
		...
		( isset( $_GET['settings-updated'] ) && '1' === $_GET['settings-updated'] )
			...
			echo '<span style="padding:0 2em;">' . wp_kses_post( __( 'Perhaps you should head on over and upgrade now. Head on over there and <a href="update-core.php">upgrade now</a>!', 'wordpress-beta-tester' ) ) . '</span>';
			echo '</p></div>';
		}
	}
